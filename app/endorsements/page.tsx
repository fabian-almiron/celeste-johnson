      ...
      <section className="py-16 bg-neutral-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-8 md:p-12 border border-neutral-200">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/contact"
              className="inline-block bg-secondary hover:bg-secondary-dark px-8 py-4 rounded-lg font-bold text-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              Get in Touch
            </Link>
          </div>
